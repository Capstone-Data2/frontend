    ...
    function RenderTeamTable({ team, name, win, color }) {
        return (
            ...
            >
                ...
                {Object.keys(playersMemoized).length !== 0 && Object.keys(performance).length !== 0 && (
                    <MatchPerformanceTable players={playersMemoized[team.toLowerCase()]} performance={performance} />
                )}
            </Box>
        );
    }
